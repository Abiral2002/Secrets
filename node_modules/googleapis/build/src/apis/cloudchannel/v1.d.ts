...
export declare namespace cloudchannel_v1 {
    ...
    export class Resource$Accounts$Channelpartnerlinks$Customers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        import(params: Params$Resource$Accounts$Channelpartnerlinks$Customers$Import, options: StreamMethodOptions): GaxiosPromise<Readable>;
        import(params?: Params$Resource$Accounts$Channelpartnerlinks$Customers$Import, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1Customer>;
    ...
    export class Resource$Accounts$Customers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        import(params: Params$Resource$Accounts$Customers$Import, options: StreamMethodOptions): GaxiosPromise<Readable>;
        import(params?: Params$Resource$Accounts$Customers$Import, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudChannelV1Customer>;
