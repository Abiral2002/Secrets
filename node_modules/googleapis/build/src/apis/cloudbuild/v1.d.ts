...
export declare namespace cloudbuild_v1 {
    ...
    export class Resource$Projects$Locations$Bitbucketserverconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addBitbucketServerConnectedRepository(params: Params$Resource$Projects$Locations$Bitbucketserverconfigs$Addbitbucketserverconnectedrepository, options: StreamMethodOptions): GaxiosPromise<Readable>;
        addBitbucketServerConnectedRepository(params?: Params$Resource$Projects$Locations$Bitbucketserverconfigs$Addbitbucketserverconnectedrepository, options?: MethodOptions): GaxiosPromise<Schema$AddBitbucketServerConnectedRepositoryResponse>;
        addBitbucketServerConnectedRepository(params: Params$Resource$Projects$Locations$Bitbucketserverconfigs$Addbitbucketserverconnectedrepository, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        addBitbucketServerConnectedRepository(params: Params$Resource$Projects$Locations$Bitbucketserverconfigs$Addbitbucketserverconnectedrepository, options: MethodOptions | BodyResponseCallback<Schema$AddBitbucketServerConnectedRepositoryResponse>, callback: BodyResponseCallback<Schema$AddBitbucketServerConnectedRepositoryResponse>): void;
        addBitbucketServerConnectedRepository(params: Params$Resource$Projects$Locations$Bitbucketserverconfigs$Addbitbucketserverconnectedrepository, callback: BodyResponseCallback<Schema$AddBitbucketServerConnectedRepositoryResponse>): void;
        addBitbucketServerConnectedRepository(callback: BodyResponseCallback<Schema$AddBitbucketServerConnectedRepositoryResponse>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Bitbucketserverconfigs$Addbitbucketserverconnectedrepository extends StandardParameters {
        /**
         * Required. The name of the `BitbucketServerConfig` to add a connected repository. Format: `projects/{project\}/locations/{location\}/bitbucketServerConfigs/{config\}`
         */
        config?: string;
