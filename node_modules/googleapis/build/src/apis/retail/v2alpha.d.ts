...
export declare namespace retail_v2alpha {
    ...
    export class Resource$Projects$Locations$Catalogs {
        ...
        completeQuery(params?: Params$Resource$Projects$Locations$Catalogs$Completequery, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaCompleteQueryResponse>;
        ...
        completeQuery(params: Params$Resource$Projects$Locations$Catalogs$Completequery, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCompleteQueryResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCompleteQueryResponse>): void;
        completeQuery(params: Params$Resource$Projects$Locations$Catalogs$Completequery, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCompleteQueryResponse>): void;
        completeQuery(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCompleteQueryResponse>): void;
        /**
        ...
        getAttributesConfig(params?: Params$Resource$Projects$Locations$Catalogs$Getattributesconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaAttributesConfig>;
        ...
        getAttributesConfig(params: Params$Resource$Projects$Locations$Catalogs$Getattributesconfig, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        getAttributesConfig(params: Params$Resource$Projects$Locations$Catalogs$Getattributesconfig, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        getAttributesConfig(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        /**
        ...
        getDefaultBranch(params?: Params$Resource$Projects$Locations$Catalogs$Getdefaultbranch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaGetDefaultBranchResponse>;
        ...
        getDefaultBranch(params: Params$Resource$Projects$Locations$Catalogs$Getdefaultbranch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaGetDefaultBranchResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaGetDefaultBranchResponse>): void;
        getDefaultBranch(params: Params$Resource$Projects$Locations$Catalogs$Getdefaultbranch, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaGetDefaultBranchResponse>): void;
        getDefaultBranch(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaGetDefaultBranchResponse>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Locations$Catalogs$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaListCatalogsResponse>;
        ...
        list(params: Params$Resource$Projects$Locations$Catalogs$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListCatalogsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListCatalogsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Catalogs$List, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListCatalogsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListCatalogsResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Projects$Locations$Catalogs$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaCatalog>;
        ...
        patch(params: Params$Resource$Projects$Locations$Catalogs$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCatalog>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCatalog>): void;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Patch, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCatalog>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaCatalog>): void;
        /**
        ...
        updateAttributesConfig(params?: Params$Resource$Projects$Locations$Catalogs$Updateattributesconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaAttributesConfig>;
        ...
        updateAttributesConfig(params: Params$Resource$Projects$Locations$Catalogs$Updateattributesconfig, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        updateAttributesConfig(params: Params$Resource$Projects$Locations$Catalogs$Updateattributesconfig, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        updateAttributesConfig(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Attributesconfig {
        ...
        addCatalogAttribute(params?: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Addcatalogattribute, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaAttributesConfig>;
        ...
        addCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Addcatalogattribute, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        addCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Addcatalogattribute, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        addCatalogAttribute(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        /**
        ...
        removeCatalogAttribute(params?: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Removecatalogattribute, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaAttributesConfig>;
        ...
        removeCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Removecatalogattribute, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        removeCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Removecatalogattribute, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        removeCatalogAttribute(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        replaceCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Replacecatalogattribute, options: StreamMethodOptions): GaxiosPromise<Readable>;
        replaceCatalogAttribute(params?: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Replacecatalogattribute, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaAttributesConfig>;
        replaceCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Replacecatalogattribute, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        replaceCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Replacecatalogattribute, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        replaceCatalogAttribute(params: Params$Resource$Projects$Locations$Catalogs$Attributesconfig$Replacecatalogattribute, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
        replaceCatalogAttribute(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaAttributesConfig>): void;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Branches$Products {
        ...
        create(params?: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaProduct>;
        ...
        create(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        create(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Create, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        /**
         * Deletes a Product.
         * @example
         * ```js
        ...
        get(params?: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaProduct>;
        ...
        get(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        get(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Get, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        /**
        ...
        list(params?: Params$Resource$Projects$Locations$Catalogs$Branches$Products$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaListProductsResponse>;
        ...
        list(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListProductsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListProductsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$List, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListProductsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListProductsResponse>): void;
        /**
         * Updates a Product.
         * @example
         * ```js
        ...
        patch(params?: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaProduct>;
        ...
        patch(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Patch, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaProduct>): void;
        /**
    ...
    export class Resource$Projects$Locations$Catalogs$Controls {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Catalogs$Controls$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Catalogs$Controls$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaControl>;
        create(params: Params$Resource$Projects$Locations$Catalogs$Controls$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Catalogs$Controls$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        create(params: Params$Resource$Projects$Locations$Catalogs$Controls$Create, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Catalogs$Controls$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Catalogs$Controls$Delete, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobufEmpty>;
        delete(params: Params$Resource$Projects$Locations$Catalogs$Controls$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Catalogs$Controls$Delete, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobufEmpty>, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        delete(params: Params$Resource$Projects$Locations$Catalogs$Controls$Delete, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        delete(callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        /**
         * Gets a Control.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Catalogs$Controls$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Catalogs$Controls$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaControl>;
        get(params: Params$Resource$Projects$Locations$Catalogs$Controls$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Catalogs$Controls$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        get(params: Params$Resource$Projects$Locations$Catalogs$Controls$Get, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Catalogs$Controls$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Catalogs$Controls$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaListControlsResponse>;
        list(params: Params$Resource$Projects$Locations$Catalogs$Controls$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Catalogs$Controls$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListControlsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListControlsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Catalogs$Controls$List, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListControlsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListControlsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Catalogs$Controls$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Locations$Catalogs$Controls$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaControl>;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Controls$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Controls$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Controls$Patch, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaControl>): void;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Placements {
        ...
        predict(params?: Params$Resource$Projects$Locations$Catalogs$Placements$Predict, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaPredictResponse>;
        ...
        predict(params: Params$Resource$Projects$Locations$Catalogs$Placements$Predict, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaPredictResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaPredictResponse>): void;
        predict(params: Params$Resource$Projects$Locations$Catalogs$Placements$Predict, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaPredictResponse>): void;
        predict(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaPredictResponse>): void;
        /**
        ...
        search(params?: Params$Resource$Projects$Locations$Catalogs$Placements$Search, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaSearchResponse>;
        ...
        search(params: Params$Resource$Projects$Locations$Catalogs$Placements$Search, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaSearchResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaSearchResponse>): void;
        search(params: Params$Resource$Projects$Locations$Catalogs$Placements$Search, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaSearchResponse>): void;
        search(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaSearchResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Servingconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Addcontrol, options: StreamMethodOptions): GaxiosPromise<Readable>;
        addControl(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Addcontrol, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaServingConfig>;
        addControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Addcontrol, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        addControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Addcontrol, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        addControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Addcontrol, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        addControl(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaServingConfig>;
        create(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        create(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Create, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        create(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Delete, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobufEmpty>;
        delete(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Delete, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobufEmpty>, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        delete(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Delete, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        delete(callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaServingConfig>;
        get(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        get(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Get, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaListServingConfigsResponse>;
        list(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListServingConfigsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListServingConfigsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$List, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListServingConfigsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaListServingConfigsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaServingConfig>;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        patch(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Patch, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        removeControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Removecontrol, options: StreamMethodOptions): GaxiosPromise<Readable>;
        removeControl(params?: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Removecontrol, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaServingConfig>;
        removeControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Removecontrol, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        removeControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Removecontrol, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        removeControl(params: Params$Resource$Projects$Locations$Catalogs$Servingconfigs$Removecontrol, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
        removeControl(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaServingConfig>): void;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Userevents {
        ...
        write(params?: Params$Resource$Projects$Locations$Catalogs$Userevents$Write, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRetailV2alphaUserEvent>;
        ...
        write(params: Params$Resource$Projects$Locations$Catalogs$Userevents$Write, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRetailV2alphaUserEvent>, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaUserEvent>): void;
        write(params: Params$Resource$Projects$Locations$Catalogs$Userevents$Write, callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaUserEvent>): void;
        write(callback: BodyResponseCallback<Schema$GoogleCloudRetailV2alphaUserEvent>): void;
    }
