...
export declare namespace gkehub_v1alpha {
    ...
    export class Resource$Projects$Locations$Fleets {
        ...
        create(params?: Params$Resource$Projects$Locations$Fleets$Create, options?: MethodOptions): GaxiosPromise<Schema$Fleet>;
        ...
        create(params: Params$Resource$Projects$Locations$Fleets$Create, options: MethodOptions | BodyResponseCallback<Schema$Fleet>, callback: BodyResponseCallback<Schema$Fleet>): void;
        create(params: Params$Resource$Projects$Locations$Fleets$Create, callback: BodyResponseCallback<Schema$Fleet>): void;
        ...
        delete(params?: Params$Resource$Projects$Locations$Fleets$Delete, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
        ...
        delete(params: Params$Resource$Projects$Locations$Fleets$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Fleets$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        ...
        patch(params?: Params$Resource$Projects$Locations$Fleets$Patch, options?: MethodOptions): GaxiosPromise<Schema$Fleet>;
        ...
        patch(params: Params$Resource$Projects$Locations$Fleets$Patch, options: MethodOptions | BodyResponseCallback<Schema$Fleet>, callback: BodyResponseCallback<Schema$Fleet>): void;
        patch(params: Params$Resource$Projects$Locations$Fleets$Patch, callback: BodyResponseCallback<Schema$Fleet>): void;
