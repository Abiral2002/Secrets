...
export declare namespace bigqueryreservation_v1beta1 {
    ...
    export class Resource$Projects$Locations$Reservations$Assignments {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Reservations$Assignments$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Locations$Reservations$Assignments$Patch, options?: MethodOptions): GaxiosPromise<Schema$Assignment>;
