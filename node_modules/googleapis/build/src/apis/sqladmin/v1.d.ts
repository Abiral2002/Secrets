...
export declare namespace sqladmin_v1 {
    ...
    export class Resource$Connect {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateEphemeralCert(params: Params$Resource$Connect$Generateephemeralcert, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generateEphemeralCert(params?: Params$Resource$Connect$Generateephemeralcert, options?: MethodOptions): GaxiosPromise<Schema$GenerateEphemeralCertResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Connect$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Connect$Get, options?: MethodOptions): GaxiosPromise<Schema$ConnectSettings>;
